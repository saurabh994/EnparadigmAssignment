package com.example.enparadigmassignment.ui.base.adapter
...
abstract class BaseListAdapter<T>(diffCallback: DiffUtil.ItemCallback<T>) : ListAdapter<T, BaseViewHolder<T>>(diffCallback) {
